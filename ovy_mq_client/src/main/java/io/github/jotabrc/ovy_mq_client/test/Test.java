...
public class Test {
    ...
    @OvyListener(topic = "bar", quantity = 0, pollInitialDelay = 15000, healthCheckInitialDelay = 15000, processingTimeout = 180000)
    ...
    @OvyListener(topic = "foo", quantity = 0, processingTimeout = 180000)
