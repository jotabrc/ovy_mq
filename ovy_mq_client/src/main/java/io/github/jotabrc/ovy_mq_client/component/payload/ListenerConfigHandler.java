...
import io.github.jotabrc.ovy_mq_client.component.resource.ShutdownClientComponent;
import io.github.jotabrc.ovy_mq_client.component.session.initialize.SessionInitializer;
...
public class ListenerConfigHandler implements PayloadHandler<ListenerConfig> {
    ...
    public void handle(Client client, ListenerConfig payload, StompHeaders headers) {
        ...
        lockProcessor.getLockAndExecute(callable, Value.LOCK_KEY_VALUE.apply(payload.getTopic()), null, null);
    }
