...
import static io.github.jotabrc.ovy_mq_client.domain.Command.SEND_MESSAGE_TO_CONSUMER;
...
public class ClientMessageHandlerImpl implements ClientMessageHandler {
    ...
    public void handleMessage(String topic, MessagePayload messagePayload) {
        ...
        try {
            ActionFactory.of(ClientFactory.createConsumer(topic), messagePayload).execute(SEND_MESSAGE_TO_CONSUMER);
